...
if __name__ == "__main__":
    for folder in ["DATA1","DATA2","DATA3"]:
        ...
        print(results["top_days"])
        print("Unique users:", results["unique_users"])
        print("Unique sets of authors:", results["unique_author_sets"])
        print("Most popular author(s):", [", ".join(a) for a in results["popular_authors"]] if results["popular_authors"] else "None")
        print("Best buyer aliases:", results["alias_ids"] if results["alias_ids"] else "None")
